              ...
              : SingleChildScrollView(
                  ...
                  child: DataTable(
                    columns: const [
                      ...
                      DataColumn(label: Text('Cupo Actual Antes')),
                      DataColumn(label: Text('Cupo Actual Después')),
                    ...
                    rows: _movimientos.map((m) => DataRow(cells: [
                      ...
                      DataCell(Text(m.cupoActualAntes?.toStringAsFixed(2) ?? '-')),
                      DataCell(Text(m.cupoActualDespues?.toStringAsFixed(2) ?? '-')),
